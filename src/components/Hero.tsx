        ...
        <div className="flex flex-col items-center text-center">
          <div className="w-full">
            ...
            <div className="mt-8 md:mt-14 grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 pt-6 md:pt-10 border-t border-white/10 max-w-2xl mx-auto">
              {[
                { title: "Verificação inicial gratuita", icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" },
                { title: "Retorno em 24 horas", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
                { title: "Equipe especializada em saúde", icon: "M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3" }
              ].map((item, i) => (
