...
const rights = [
  ...
  },
  {
    ...
    title: "1.3 Milhão na Fila",
    desc: "Mais de 1.3 milhão de brasileiros aguardam procedimentos no SUS. A espera média é de 634 dias. Você não está sozinho.",
    tag: "CNJ / DATASUS, 2024-2025",
